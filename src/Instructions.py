...
def blit_logo(DISPLAY, w, h):
    logo = pygame.image.load('logo150.png')
...
def button(msg, x, y, w, h, DISPLAY):
    ...
    smallText = pygame.font.Font("Ubuntu-B.ttf", 18)
...
def blit_all_info(DISPLAY, display_width, display_height):
    ...
    regular = pygame.font.Font("Ubuntu-R.ttf", 14)
    small = pygame.font.Font("Ubuntu-R.ttf", 10)
    bold = pygame.font.Font("Ubuntu-B.ttf", 14)
